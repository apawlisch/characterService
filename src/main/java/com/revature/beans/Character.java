...
public class Character implements Serializable {
	...
	public Character(String characterName, String userName, Integer strength, Integer dexterity,
	...
	public Character(String characterName, String userName) {
		this();
		this.characterName = characterName;
		this.userName = userName;
	}
	...
	public String toString() {
		return "Character [characterName=" + characterName + ", userName=" + userName + ", strength=" + strength
				+ ", dexterity=" + dexterity + ", constitution=" + constitution + ", intelligence=" + intelligence
				+ ", wisdom=" + wisdom + ", charisma=" + charisma + ", armorClass=" + armorClass + ", initiative="
				+ initiative + ", maxHitPoints=" + maxHitPoints + ", currentHitPoints=" + currentHitPoints + ", speed="
				+ speed + "]";
	}
